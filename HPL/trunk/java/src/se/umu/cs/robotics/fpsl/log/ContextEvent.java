 ...
 */
public abstract class ContextEvent extends AbstractHplLogMessage {

    private final FContext context;

    public ContextEvent(FContext context) {
        this.context = context;
    }

    protected String messageStartTag() {
        return messageStartTag("ContextEvent");
    }
